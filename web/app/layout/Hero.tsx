            ...
            <div className="py-10 lg:overflow-hidden relative z-20">
                <div className="mx-auto max-w-7xl lg:px-8">
                    <div className={hasParagraph ? 'lg:grid lg:grid-cols-2 lg:gap-8' : ''}>
                        <div
                            className={`mx-auto max-w-md px-4 sm:max-w-2xl sm:px-6 sm:text-center lg:px-0 ${hasParagraph ? 'lg:text-left lg:flex lg:items-center' : ''}`}
                        >
                            <div
                                className={`${hero.heroUpperCta?.linkData && hero.heroUpperCta.linkText ? 'py-24' : 'py-6'}`}
                            >
                                {(() => {
